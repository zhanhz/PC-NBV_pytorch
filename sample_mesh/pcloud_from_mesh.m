function points = pcloud_from_mesh(np, density_dist, filename)
...
%     [pcloud.points, pcloud.normals, pcloud.curvatures, ~] = sample_mesh(vertices, faces, np, use_curvature, density_dist);
    [points, pcloud.normals, pcloud.curvatures, ~] = sample_mesh_points(vertices, faces, np, use_curvature, density_dist);
